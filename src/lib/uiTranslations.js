...
export const uiTranslations = {
  ...
  ar: {
    ...
    dashboard: {
      ...
      staffViewSubtitle: 'هنا يمكنك عرض وإدارة جميع الطلبات المقدّمة.',
      registerNewTicket: 'تسجيل طلب جديد',
    },
    ...
    login: {
      ...
      loginErrorDescription: 'تحقق من بريدك الإلكتروني وكلمة المرور وحاول مرة أخرى.',
    },

    // ---- AdminPanel ----
    admin: {
      title: 'لوحة الإدارة',
      subtitle: 'الإحصائيات وإدارة المستخدمين.',
      refreshStats: 'تحديث الإحصائيات',
      tabReports: 'التقارير',
      tabUsers: 'المستخدمون',
      tabMessages: 'الرسائل',
      tabFooters: 'التذييلات',
      tabTemplates: 'النصوص القياسية',
      tabAi: 'أوامر الذكاء الاصطناعي',
      totalTickets: 'إجمالي الطلبات',
      closedTickets: 'الطلبات المغلقة',
      avgRepairTime: 'متوسط وقت الإصلاح',
      avgNotifyTime: 'متوسط جاهز ← إبلاغ',
      avgPickupTime: 'متوسط جاهز ← استلام',
      dateFrom: 'من',
      dateTo: 'إلى',
      applyFilter: 'تطبيق الفلتر',
      statsErrorTitle: 'تعذّر جلب الإحصائيات',
      statsErrorDescription: 'تحقق من الصلاحيات وحاول مرة أخرى.',
      chatDefaultLanguageLabel: 'لغة الدردشة الداخلية (افتراضي)',
      chatDefaultLanguagePlaceholder: 'اختر اللغة',
      chatDefaultLanguageHint: 'تُعرض رسائل العميل بالأصل + الترجمة إلى هذه اللغة (داخليًا فقط).',
      autoTranslateButton: 'ترجمة تلقائية لجميع اللغات',
      autoTranslateButtonLoading: 'جارٍ الترجمة...',
      autoTranslateHint: 'أدخل النص بالسويدية/الإنجليزية ودع النظام يترجم تلقائيًا.',
      emailFooterTitle: 'تذييل البريد الإلكتروني',
      smsFooterTitle: 'تذييل الرسائل القصيرة',
      costProposalTemplateTitle: 'نص قياسي: عرض التكلفة',
      costProposalTemplateHint: 'يمكنك استخدام المتغيرات: {{diagnosis}}، {{amount}}، {{ticket_number}}، {{customer_name}}.',
      repairReadyTemplateTitle: 'نص قياسي: الإصلاح جاهز',
      repairReadyTemplateHint: 'يمكنك استخدام المتغيرات: {{work_done}}، {{final_cost}}، {{ticket_number}}، {{customer_name}}.',
      autoReplyApprovedTitle: 'رد تلقائي: عرض التكلفة مقبول',
      autoReplyApprovedHint: 'المتغيرات: {{customer_name}}، {{ticket_number}}، {{amount}}.',
      autoReplyDeclinedTitle: 'رد تلقائي: عرض التكلفة مرفوض',
      autoReplyDeclinedHint: 'المتغيرات: {{customer_name}}، {{ticket_number}}، {{amount}}.',
      autoReplyUnclearTitle: 'رد تلقائي: رد غير واضح',
      autoReplyUnclearHint: 'المتغيرات: {{customer_name}}، {{ticket_number}}.',
      emailSubjectPlaceholder: 'موضوع البريد',
      emailBodyPlaceholder: 'نص البريد',
      smsTextPlaceholder: 'نص الرسالة القصيرة',
      aiReplyPromptTitle: 'أمر الذكاء الاصطناعي: مساعد الرد',
      aiSuggestionPromptTitle: 'أمر الذكاء الاصطناعي: اقتراح رسالة',
      aiWorkDonePromptTitle: 'أمر الذكاء الاصطناعي: الأعمال المنجزة',
      aiWorkDonePromptHint: 'يُستخدم عند تحويل الإجراءات المخططة إلى حقل الأعمال المنجزة.',
      saveMessageSettings: 'حفظ إعدادات الرسائل',
      saveMessageSettingsLoading: 'جارٍ الحفظ...',
      savedTitle: 'تم الحفظ',
      savedDescription: 'تم تحديث إعدادات الرسائل.',
      saveErrorTitle: 'تعذّر الحفظ',
      saveErrorDescription: 'حاول مرة أخرى.',
      autoTranslateDoneTitle: 'تم',
      autoTranslateDoneDescription: 'تم تحديث الترجمات لجميع اللغات.',
      autoTranslateErrorTitle: 'فشلت الترجمة التلقائية',
      autoTranslateErrorDescription: 'تحقق من مفتاح DeepSeek وحاول مرة أخرى.',
      messageSettingsErrorTitle: 'تعذّر جلب إعدادات الرسائل',
      messageSettingsErrorDescription: 'حاول مرة أخرى.',
      ...
      createUserErrorTitle: 'تعذّر إنشاء المستخدم',
      createUserErrorDescription: 'تحقق من البيانات وحاول مرة أخرى.',
      updateUserErrorTitle: 'تعذّر تحديث المستخدم',
      updateUserErrorDescription: 'حاول مرة أخرى.',
      fillAllFieldsTitle: 'أكمل جميع الحقول',
      fillAllFieldsDescription: 'البريد الإلكتروني وكلمة المرور والدور مطلوبة.',
      testEmailTitle: 'اختبار البريد',
      testEmailRecipientLabel: 'المستلم',
      sendTestEmail: 'إرسال بريد اختباري',
      testEmailSentTitle: 'تم إرسال البريد الاختباري',
      testEmailSentDescription: 'تحقق من صندوق الوارد لـ {email}.',
      testEmailErrorTitle: 'تعذّر إرسال البريد الاختباري',
      testEmailErrorFallbackDescription: 'تحقق من إعدادات SMTP/Resend.',
      fillEmailTitle: 'أدخل البريد الإلكتروني',
      fillEmailDescription: 'أدخل مستلمًا للبريد الاختباري.',
    },

    // ---- ServiceDashboard ----
    serviceDashboard: {
      title: 'عرض الموظفين - سجل الخدمة',
      tabNewTicket: 'طلب جديد',
      tabTicketList: 'قائمة الطلبات',
    },

    // ---- ServiceRegister (ticket list) ----
    register: {
      searchPlaceholder: 'ابحث بالاسم أو رقم الطلب أو الطراز...',
      showCompleted: 'عرض الطلبات المكتملة',
      columnTicketNo: 'رقم الطلب',
      columnCustomer: 'العميل',
      columnDevice: 'الجهاز',
      columnStatus: 'الحالة',
      noTicketsFound: 'لم يتم العثور على طلبات.',
    },
    ...
    tickets: {
      ...
      statusWaitingCustomer: 'بانتظار العميل',
      statusCostApproved: 'عرض التكلفة مقبول',
      statusCostDeclined: 'عرض التكلفة مرفوض',
      statusDone: 'جاهز',
      statusClosed: 'مغلق',
      decisionApproved: 'رد العميل: مقبول',
      decisionDeclined: 'رد العميل: مرفوض',
      decisionPending: 'رد العميل: بانتظار التقييم',
      decisionUnknown: 'رد العميل: رد غير واضح',
      channelUnknown: 'قناة غير معروفة',
      channelSmsEmail: 'رسالة قصيرة + بريد إلكتروني',
      ...
      contactSms: 'رسالة قصيرة',
      contactEmail: 'بريد إلكتروني',
      contactAutomatic: 'تلقائي',
      disclaimerLanguage: 'إخلاء المسؤولية:',
      createdAt: 'تاريخ الإنشاء:',
      deviceInfoTitle: 'معلومات الجهاز',
      modelNotProvided: 'الطراز غير محدد',
      issueDescription: 'وصف المشكلة:',
      customerNotes: 'ملاحظات من العميل:',
      latestDiagnosis: 'آخر تشخيص:',
      communicationTitle: 'التواصل',
      loadingMessages: 'جارٍ التحميل...',
      noCommunication: 'لم يتم تسجيل أي تواصل بعد.',
      outboundSender: 'أنتم',
      subjectPlaceholder: 'الموضوع',
      composeDefaultSubject: 'رد: طلب #{ticketNumber}',
      composePlaceholder: 'اكتب رسالة للعميل...',
      aiSuggestTitle: 'إنشاء اقتراح بالذكاء الاصطناعي',
      sendTitle: 'إرسال',
      messageDetailTitle: 'تفاصيل الرسالة',
      directionOutbound: 'صادر',
      directionInbound: 'وارد',
      detailSubject: 'الموضوع',
      detailBody: 'النص',
      noBodyReceived: '(لم يتم استلام نص في الويب هوك)',
      parserLabel: 'المحلل:',
      parserMethodUnknown: 'غير معروف',
      confidenceLabel: 'الثقة:',
      rawBodyTitle: 'البريد الأصلي (نص خام)',
      handlingTitle: 'المعالجة',
      plannedActionsLabel: 'الإجراءات المخططة',
      plannedActionsPlaceholder: 'صف الإجراءات المخططة...',
      costProposalLabel: 'عرض التكلفة (كرونة)',
      costProposalPlaceholder: 'مثلاً 1299',
      sendCostProposal: 'إرسال عرض التكلفة',
      costProposalApprovedLabel: 'عرض التكلفة مقبول',
      workDoneLabel: 'الأعمال المنجزة',
      workDonePlaceholder: 'صف ما تم إنجازه...',
      finalCostLabel: 'التكلفة النهائية (كرونة)',
      finalCostPlaceholder: 'مثلاً 1299',
      notifyRepairReady: 'إبلاغ بأن الإصلاح جاهز',
      internalNotesLabel: 'ملاحظات داخلية',
      internalNotesPlaceholder: 'ملاحظات للموظفين فقط...',
      finalizeButton: 'تسليم وطباعة الإيصال',
      ticketClosed: 'الطلب مغلق',
      finalizeReceiptHint: 'ينشئ إيصالًا واضحًا للعميل.',
      closeWithoutAction: 'إغلاق بدون إجراء',
      reprintButton: 'طباعة مرة أخرى',
      showButton: 'عرض',
      hideButton: 'إخفاء',
      messageBodyMissing: 'نص الرسالة مفقود',
      sentTitle: 'تم الإرسال',
      sentDescription: 'تم إرسال الرسالة إلى العميل.',
      sendErrorTitle: 'تعذّر الإرسال',
      sendErrorFallback: 'حاول مرة أخرى.',
      aiSuggestionReadyTitle: 'اقتراح الذكاء الاصطناعي جاهز',
      aiSuggestionReadyDescription: 'الاقتراح مُكيّف مع لغة العميل ({language}).',
      aiSuggestionErrorTitle: 'فشل اقتراح الذكاء الاصطناعي',
      aiSuggestionErrorFallback: 'حاول مرة أخرى.',
      notesSavedTitle: 'تم حفظ الملاحظات',
      actionsSavedTitle: 'تم حفظ الإجراءات',
      costSavedTitle: 'تم حفظ التكلفة',
      ticketUpdatedDescription: 'تم تحديث الطلب #{ticketNumber}.',
      approvingTitle: 'جارٍ الموافقة...',
      approvingDescription: 'نقوم بملء الأعمال المنجزة وتحديث الطلب.',
      approvedTitle: 'تمت الموافقة على عرض التكلفة!',
      approvedDescription: 'تم ملء الأعمال المنجزة والتكلفة النهائية ويمكن تعديلها يدويًا.',
      statusUpdatedTitle: 'تم تحديث الحالة',
      statusUpdatedDescription: 'تم تغيير حالة الطلب #{ticketNumber} إلى "{status}".',
      permissionMissingTitle: 'الصلاحية مطلوبة',
      permissionMissingDescription: 'ليس لديك صلاحية تحديث الطلبات.',
      contactMissingTitle: 'معلومات الاتصال مفقودة',
      contactMissingDescription: 'لا يمكن إبلاغ العميل لعدم وجود رقم هاتف أو بريد إلكتروني مسجّل.',
      finalizeMissingTitle: 'معلومات مفقودة',
      finalizeMissingDescription: 'أكمل "الأعمال المنجزة" و"التكلفة النهائية" قبل إغلاق الطلب.',
      creatingReceiptTitle: 'جارٍ إنشاء الإيصال...',
      creatingReceiptDescription: 'تحضير الإيصال النهائي.',
      printBlockedError: 'تم حظر نافذة الطباعة.',
      ticketClosedTitle: 'تم إغلاق الطلب!',
      ticketClosedDescription: 'تم عرض الإيصال وتم تحديد الطلب #{ticketNumber} كمغلق.',
      finalizeErrorTitle: 'حدث خطأ',
      finalizeErrorDescription: 'تعذّر إنشاء الإيصال. حاول مرة أخرى.',
      closeConfirm: 'إغلاق الطلب #{ticketNumber} بدون إجراء؟\nسيتم تحديده كمغلق.',
      closedWithoutActionDefault: 'مغلق بدون إجراء (عرض التكلفة مرفوض).',
      closedWithoutActionTitle: 'تم إغلاق الطلب',
      closedWithoutActionDescription: 'تم إغلاق الطلب #{ticketNumber} بدون إجراء.',
      closeErrorTitle: 'تعذّر إغلاق الطلب',
      closeErrorFallback: 'حاول مرة أخرى.',
      reprintTitle: 'تم إنشاء الطباعة',
      reprintDescription: 'تم إنشاء إيصال التسليم للطلب #{ticketNumber}.',
      hiddenTitle: 'تم إخفاء الطلب',
      visibleTitle: 'الطلب مرئي',
      hiddenDescription: 'الطلب #{ticketNumber} مخفي الآن من القائمة.',
      visibleDescription: 'الطلب #{ticketNumber} مرئي الآن في القائمة.',
    },
    ...
    ticketActions: {
      ...
      permissionMissingTitle: 'الصلاحية مطلوبة',
      permissionMissingDescription: 'ليس لديك صلاحية تحديث الطلبات.',
      emailMissingTitle: 'البريد الإلكتروني مفقود',
      emailMissingDescription: 'لا يمكن إبلاغ العميل لعدم وجود بريد إلكتروني مسجّل.',
    },

    // ---- SuperAdminPage ----
    superadmin: {
      title: 'المدير الأعلى',
      subtitle: 'نظرة عامة على المنصة وإدارة المستأجرين.',
      backToDashboard: 'العودة إلى لوحة القيادة',
      tabDashboard: 'لوحة القيادة',
      tabTenants: 'المستأجرون',
      usageTitle: 'إحصائيات الرسائل',
      dateFrom: 'من',
      dateTo: 'إلى',
      applyFilter: 'فلتر',
      tenantColumn: 'المستأجر',
      smsOutbound: 'رسائل صادرة',
      smsInbound: 'رسائل واردة',
      emailOutbound: 'بريد صادر',
      emailInbound: 'بريد وارد',
      totalMessages: 'الإجمالي',
      summaryTitle: 'الملخص',
      totalSmsOut: 'إجمالي الرسائل الصادرة',
      totalSmsIn: 'إجمالي الرسائل الواردة',
      totalEmailOut: 'إجمالي البريد الصادر',
      totalEmailIn: 'إجمالي البريد الوارد',
      grandTotal: 'إجمالي الرسائل',
      noUsageData: 'لم يتم العثور على بيانات رسائل.',
      usageErrorTitle: 'تعذّر جلب الإحصائيات',
      usageErrorDescription: 'حاول مرة أخرى.',
      tenantsTitle: 'جميع المستأجرين',
      createTenant: 'إنشاء مستأجر جديد',
      editTenant: 'تعديل المستأجر',
      tenantName: 'الاسم',
      tenantSlug: 'المعرّف',
      tenantEmail: 'بريد الدعم',
      tenantPhone: 'هاتف الدعم',
      tenantActive: 'نشط',
      tenantInactive: 'غير نشط',
      tenantCreatedAt: 'تاريخ الإنشاء',
      brandConfig: 'إعدادات العلامة التجارية (JSON)',
      saveTenant: 'حفظ',
      cancelEdit: 'إلغاء',
      noTenants: 'لم يتم العثور على مستأجرين.',
      tenantCreatedTitle: 'تم إنشاء المستأجر',
      tenantUpdatedTitle: 'تم تحديث المستأجر',
      tenantErrorTitle: 'تعذّر حفظ المستأجر',
      tenantErrorDescription: 'تحقق من البيانات وحاول مرة أخرى.',
      slugExistsError: 'يوجد مستأجر بهذا المعرّف بالفعل.',
      confirmDeactivate: 'هل تريد تعطيل هذا المستأجر؟',
      confirmActivate: 'هل تريد تفعيل هذا المستأجر؟',
    },

    // ---- EmailTemplateDialog ----
    emailDialog: {
      costProposalTitle: 'تفاصيل عرض التكلفة',
      repairReadyTitle: 'رسالة إلى العميل',
      costProposalDescription: 'راجع وانسخ وأرسل عرض التكلفة هذا إلى العميل.',
      repairReadyDescription: 'راجع وانسخ وأرسل رسالة جاهزية الإصلاح.',
      templateLanguageLabel: 'لغة القالب',
      templateLanguagePlaceholder: 'اختر اللغة...',
      diagnosisLabel: 'التشخيص',
      costProposalFieldLabel: 'عرض التكلفة (كرونة)',
      costProposalFieldPlaceholder: 'أدخل التكلفة الإجمالية شاملة الضريبة',
      translationHint: 'يتم تكييف الترجمة عند الإرسال.',
      repairReadyHint: 'يتم إرسال الرسالة بلغة العميل المختارة إلى جميع وسائل الاتصال المتاحة.',
      previewSubjectLabel: 'الموضوع',
      previewBodyLabel: 'الرسالة',
      previewTranslationError: 'تعذّرت ترجمة المعاينة:',
      copyButton: 'نسخ النص',
      approveAndCopyButton: 'موافقة ونسخ',
      sendToCustomerButton: 'إرسال إلى العميل',
      copiedTitle: 'تم النسخ!',
      copiedCostDescription: 'تم نسخ نص عرض التكلفة إلى الحافظة.',
      copiedGenericDescription: 'تم نسخ النص إلى الحافظة.',
      costMissingTitle: 'التكلفة مفقودة',
      costMissingDescription: 'أدخل عرض التكلفة قبل الإرسال.',
      sentTitle: 'تم الإرسال!',
      sentBothDescription: 'تم إرسال رسالة قصيرة وبريد إلكتروني إلى العميل.',
      sentSmsDescription: 'تم إرسال رسالة قصيرة إلى العميل.',
      sentEmailDescription: 'تم إرسال بريد إلكتروني إلى العميل.',
      sentGenericDescription: 'تم الإرسال إلى العميل.',
      sendErrorTitle: 'تعذّر الإرسال',
      sendErrorDescription: 'تحقق من الإعدادات وحاول مرة أخرى.',
      diagnosisSavedTitle: 'تم حفظ التشخيص',
      costSavedTitle: 'تم حفظ التكلفة',
      ticketUpdatedDescription: 'تم تحديث الطلب #{ticketNumber}.',
      languageUpdatedTitle: 'تم تحديث اللغة',
      languageUpdatedDescription: 'تم تغيير لغة الطلب.',
      previewErrorFallback: 'تعذّرت ترجمة المعاينة.',
    },
  },
};
